...
public class UserController {
    ...
    @GetMapping
    public UserFindAllResponse findJoinedAllUser(@RequestParam("userNo") Long userNo,
                                            Pageable pageable) {
        Page<UserBasicDto> joinedUser = userService.findJoinedAllUser(userNo, pageable);
